...
return array (
  ...
  array (
    ...
    'meta_title_country' => 'Calcolatore IVA :country — Aliquota standard :rate% | EU VAT Info',
    'meta_desc_country' => 'Calcolatore IVA gratuito per :country. Aliquota standard :rate%. Aggiungi o rimuovi IVA istantaneamente, tutte le aliquote e guide alla conformità.',
    'meta_title_generic' => 'Calcolatore IVA UE — Tutti i 27 paesi | EU VAT Info',
    'meta_desc_generic' => 'Calcolatore IVA online gratuito per tutti i 27 stati membri dell\'UE. Calcola l\'IVA con le aliquote ufficiali attuali.',
    'schema_breadcrumb_home' => 'Home',
    'schema_breadcrumb_calculator' => 'Calcolatore IVA',
    'schema_page_name' => 'Calcolatore e guida IVA :country',
    'schema_page_desc' => 'Guida IVA completa per :country. Aliquota standard: :rate%. Calcolatore IVA gratuito, tutte le aliquote.',
    'schema_app_name' => 'Calcolatore IVA :country',
  ...
  array (
    ...
    'parking_rate' => 'Aliquota di parcheggio',
        ...
        'increases' => 'Solo aumenti',
        'decreases' => 'Solo diminuzioni',
    'all_changes' => 'Tutte le modifiche registrate',
    ...
    'no_changes' => 'Nessuna variazione delle aliquote IVA trovata corrispondente ai tuoi criteri',
        'changed_on' => 'Modificato il :date',
        'clear_filters' => 'Cancella filtri',
        'results_count' => '{0} Nessun risultato|{1} :count risultato|[2,*] :count risultati',
        'loading' => 'Caricamento…',
  ),
  'rate_changes' => 
  array (
  ...
  array (
    ...
    'history_desc' => 'Storico completo delle variazioni delle aliquote IVA in tutti i paesi UE',
        'top_calculations' => 'Calcoli IVA più popolari',
        'top_calculations_desc' => 'I calcoli IVA più popolari in tutti i paesi dell\'UE',
        'mcp_server' => 'Server MCP',
        'mcp_server_desc' => 'Server Model Context Protocol per ricerche IVA con intelligenza artificiale',
    'heading' => 'Mappa del',
    'heading_accent' => 'Sito',
  ...
  array (
    ...
    // ── VIES Validator Page ─────────────────────────────────────────────
    'vies_page' => [
        'title' => 'Validatore numero di partita IVA VIES — Verifica i numeri di partita IVA UE online',
        'description' => 'Strumento gratuito di validazione numero di partita IVA VIES. Verifica qualsiasi numero di partita IVA dell\'UE al istante attraverso il database ufficiale VIES della Commissione europea.',
        'country_title' => 'Validatore numero di partita IVA VIES :country — Verifica i numeri di partita IVA :country tramite VIES',
        'country_description' => 'Valida i numeri di partita IVA :country (:code) al istante utilizzando il database ufficiale VIES dell\'UE.',
        'h1' => 'Validatore numero di partita IVA VIES',
        'country_h1' => 'Validatore numero di partita IVA :country',
        'subtitle' => 'Verifica qualsiasi numero di partita IVA dell\'UE attraverso il database ufficiale VIES della Commissione europea. I risultati sono memorizzati nella cache per ricerche più veloci.',
        'country_subtitle' => 'Valida i numeri di partita IVA :country (:code) utilizzando il database ufficiale VIES dell\'UE.',
        'nav_title' => 'Validatore numero di partita IVA',
        'vat_number_label' => 'Numero di partita IVA',
        'vat_placeholder' => 'ad es. LT100019070512 o 123456789',
        'country_label' => 'Paese',
        'select_country' => 'Seleziona paese',
        'search_countries' => 'Ricerca paesi...',
        'validate_btn' => 'Valida',
        'auto_detect_hint' => 'Il paese viene rilevato automaticamente dal prefisso del numero di partita IVA. ',
        'try_example' => 'Prova LT100019070512',
        'country_validators' => 'Valida per paese',
        'what_is_vies' => 'Cos\'è VIES?',
        'about_vat_country' => 'Validazione della partita IVA in :country',
        'vies_p1' => 'VIES (VAT Information Exchange System) è il servizio ufficiale della Commissione europea per la verifica dei numeri di identificazione della partita IVA delle imprese registrate negli Stati membri dell\'UE.',
        'vies_p2' => 'Quando validi un numero di partita IVA attraverso VIES, il sistema controlla in tempo reale i database nazionali della partita IVA di ogni paese dell\'UE.',
        'vies_p3' => 'Il nostro validatore aggiunge un livello di caching sopra VIES, quindi i numeri precedentemente controllati restituiscono i risultati istantaneamente.',
        'country_vies_p1' => 'I numeri di partita IVA :country utilizzano il prefisso :code seguito dal numero di registrazione.',
        'country_vies_p2' => ':country applica un\'aliquota IVA standard del :rate%. Utilizza il nostro :calculator_link per calcolare gli importi dell\'IVA.',
        'country_calculator_link' => 'Calcolatore IVA per :country',
    ],
  ...
  'plus' => 'Più',
  'minus' => 'Meno',
  'vat_in' => 'IVA in :country',
  'rate_label' => 'Aliquota :name',
  'vat_added' => 'IVA aggiunta',
  'vat_extracted' => 'IVA estratta',
  'net_amount' => 'Importo netto',
  'gross_amount' => 'Importo lordo',
  'vat_percent' => 'IVA :rate%',
  'result' => 'Risultato',
  'total_incl_vat' => 'Totale IVA inclusa',
  'net_excl_vat' => 'Netto IVA esclusa',
  'switch_to_add' => 'Aggiungi IVA',
  'switch_to_extract' => 'Estrai IVA',
  'breakdown_title' => 'Dettaglio del calcolo',
  'country' => 'Paese',
  'vat_rate' => 'Aliquota IVA',
  'mode' => 'Modalità',
  'add_vat_to_net' => 'Aggiungi IVA all\'importo netto',
  'extract_vat_from_gross' => 'Estrai IVA dall\'importo lordo',
  'net_excl_label' => 'Importo netto (IVA esclusa)',
  'vat_amount' => 'Importo IVA',
  'total_incl' => 'Totale (IVA inclusa)',
  'formula_title' => 'Come è stato calcolato',
  ...
  'all_rates_title' => 'Tutte le aliquote IVA :country',
  'switch_mode' => 'Cambia modalità',
  'add_vat_to_amount' => 'Aggiungi IVA',
  'remove_vat_from_amount' => 'Rimuovi IVA',
  ...
  'heading' => 'Calcoli IVA popolari',
  'subheading' => 'Accesso rapido ai calcoli IVA più comuni.',
  'vat_on_amount' => 'IVA su €:amount',
  'country' => 'Paese',
  'rate' => 'Aliquota',
  'vat_amount' => 'Importo IVA',
  'total_incl_vat' => 'Totale IVA inclusa',
  'actions' => 'Azioni',
  'add_vat' => '+ Aggiungi IVA',
  'remove_vat' => '− Rimuovi IVA',
  'calculations_count' => ':count calcoli',
  'view_all' => 'Vedi tutti i :count calcoli →',
  'about_title' => 'Informazioni',
  'about_p1' => 'Importi IVA precalcolati per i 27 stati membri.',
  'about_p2' => 'Le aliquote standard variano dal :min% al :max%.',
  'use_calculator' => 'Usa la nostra :link.',
  'calculator_link_text' => 'Calcolatrice IVA',
