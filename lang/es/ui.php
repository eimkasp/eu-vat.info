...
return array (
  ...
  array (
    ...
    'meta_title_country' => 'Calculadora de IVA :country — Tipo general :rate% | EU VAT Info',
    'meta_desc_country' => 'Calculadora de IVA gratuita para :country. Tipo general :rate%. Añada o elimine IVA al instante, todos los tipos y guías de cumplimiento.',
    'meta_title_generic' => 'Calculadora de IVA de la UE — Los 27 países | EU VAT Info',
    'meta_desc_generic' => 'Calculadora de IVA en línea gratuita para los 27 estados miembros de la UE. Añada o elimine IVA con los tipos oficiales actuales.',
    'schema_breadcrumb_home' => 'Inicio',
    'schema_breadcrumb_calculator' => 'Calculadora de IVA',
    'schema_page_name' => 'Calculadora y guía de IVA de :country',
    'schema_page_desc' => 'Guía completa de IVA de :country. Tipo general: :rate%. Calculadora de IVA gratuita, todos los tipos, información de cumplimiento.',
    'schema_app_name' => 'Calculadora de IVA de :country',
  ...
  array (
    ...
    'parking_rate' => 'Tipo de estacionamiento',
        ...
        'increases' => 'Solo aumentos',
        'decreases' => 'Solo reducciones',
    'all_changes' => 'Todos los cambios registrados',
  ...
  array (
    ...
    'history_desc' => 'Historial completo de los cambios en los tipos de IVA en todos los países de la UE',
        'top_calculations' => 'Cálculos de IVA más populares',
        'top_calculations_desc' => 'Los cálculos de IVA más populares en todos los países de la UE',
        'mcp_server' => 'Servidor MCP',
        'mcp_server_desc' => 'Servidor Model Context Protocol para consultas de IVA con IA',
    'heading' => 'Mapa del',
  ...
  array (
    ...
    // ── VIES Validator Page ─────────────────────────────────────────────
    'vies_page' => [
        'title' => 'Validador de número de IVA VIES — Verificar números de IVA de la UE en línea',
        'description' => 'Herramienta gratuita de validación de números de IVA VIES. Verifique cualquier número de IVA de la UE al instante usando la base de datos oficial VIES de la Comisión Europea.',
        'country_title' => 'Validador de número de IVA para :country — Verificar números de IVA de :country a través de VIES',
        'country_description' => 'Valide números de IVA de :country (:code) al instante usando la base de datos oficial VIES de la UE.',
        'h1' => 'Validador de número de IVA VIES',
        'country_h1' => 'Validador de número de IVA para :country',
        'subtitle' => 'Verifique cualquier número de IVA de la UE usando la base de datos oficial VIES de la Comisión Europea. Los resultados se almacenan en caché para búsquedas más rápidas.',
        'country_subtitle' => 'Valide números de IVA de :country (:code) usando la base de datos oficial VIES de la UE.',
        'nav_title' => 'Validador de número de IVA',
        'vat_number_label' => 'Número de IVA',
        'vat_placeholder' => 'p. ej. LT100019070512 o 123456789',
        'country_label' => 'País',
        'select_country' => 'Seleccione país',
        'search_countries' => 'Buscar países...',
        'validate_btn' => 'Validar',
        'auto_detect_hint' => 'El país se detecta automáticamente a partir del prefijo del número de IVA. ',
        'try_example' => 'Pruebe LT100019070512',
        'country_validators' => 'Validar por país',
        'what_is_vies' => '¿Qué es VIES?',
        'about_vat_country' => 'Validación de IVA en :country',
        'vies_p1' => 'VIES (Sistema de Intercambio de Información sobre el IVA) es el servicio oficial de la Comisión Europea para verificar números de identificación de IVA de empresas registradas en los Estados miembros de la UE.',
        'vies_p2' => 'Cuando valida un número de IVA a través de VIES, el sistema comprueba en tiempo real frente a las bases de datos nacionales de IVA de cada país de la UE.',
        'vies_p3' => 'Nuestro validador añade una capa de almacenamiento en caché en la parte superior de VIES, por lo que los números previamente verificados devuelven resultados al instante.',
        'country_vies_p1' => 'Los números de IVA de :country utilizan el prefijo :code seguido del número de registro.',
        'country_vies_p2' => ':country aplica una tasa de IVA estándar del :rate%. Utilice nuestro :calculator_link para calcular montos de IVA.',
        'country_calculator_link' => 'Calculadora de IVA para :country',
    ],
  ...
  'plus' => 'Más',
  'minus' => 'Menos',
  'vat_in' => 'IVA en :country',
  'rate_label' => 'Tipo :name',
  'vat_added' => 'IVA añadido',
  'vat_extracted' => 'IVA extraído',
  'net_amount' => 'Importe neto',
  'gross_amount' => 'Importe bruto',
  'vat_percent' => 'IVA :rate%',
  'result' => 'Resultado',
  'total_incl_vat' => 'Total con IVA',
  'net_excl_vat' => 'Neto sin IVA',
  'switch_to_add' => 'Añadir IVA',
  'switch_to_extract' => 'Extraer IVA',
  'breakdown_title' => 'Desglose del cálculo',
  'country' => 'País',
  'vat_rate' => 'Tipo de IVA',
  'mode' => 'Modo',
  'add_vat_to_net' => 'Añadir IVA al importe neto',
  'extract_vat_from_gross' => 'Extraer IVA del importe bruto',
  'net_excl_label' => 'Importe neto (sin IVA)',
  'vat_amount' => 'Importe del IVA',
  'total_incl' => 'Total (con IVA)',
  'formula_title' => 'Cómo se calculó',
  ...
  'all_rates_title' => 'Todos los tipos de IVA de :country',
  'switch_mode' => 'Cambiar modo',
  'add_vat_to_amount' => 'Añadir IVA al importe',
  'remove_vat_from_amount' => 'Quitar IVA del importe',
  ...
  'actions' => 'Acciones',
  'add_vat' => '+ Añadir IVA',
  'remove_vat' => '− Quitar IVA',
  'calculations_count' => ':count cálculos',
  'view_all' => 'Ver los :count cálculos →',
