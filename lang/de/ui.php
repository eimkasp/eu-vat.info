...
return array (
  ...
  array (
    ...
    'meta_title_country' => 'MwSt-Rechner :country — Normalsatz :rate% | EU VAT Info',
    'meta_desc_country' => 'Kostenloser MwSt-Rechner für :country. Normalsatz :rate%. MwSt sofort hinzufügen oder entfernen, alle Sätze und Compliance-Leitfäden.',
    'meta_title_generic' => 'EU-MwSt-Rechner — Alle 27 Länder | EU VAT Info',
    'meta_desc_generic' => 'Kostenloser Online-MwSt-Rechner für alle 27 EU-Mitgliedstaaten. MwSt mit aktuellen offiziellen Sätzen sofort berechnen.',
    'schema_breadcrumb_home' => 'Startseite',
    'schema_breadcrumb_calculator' => 'MwSt-Rechner',
    'schema_page_name' => ':country MwSt-Rechner & Leitfaden',
    'schema_page_desc' => 'Vollständiger MwSt-Leitfaden für :country. Normalsatz: :rate%. Kostenloser MwSt-Rechner, alle Sätze, Compliance-Infos.',
    'schema_app_name' => ':country MwSt-Rechner',
  ...
  array (
    ...
    'parking_rate' => 'Parkingsatz',
        ...
        'increases' => 'Nur Erhöhungen',
        'decreases' => 'Nur Senkungen',
    'all_changes' => 'Alle erfassten Änderungen',
    ...
    'no_changes' => 'Keine MwSt.-Satzänderungen gefunden, die Ihren Kriterien entsprechen',
        'changed_on' => 'Geändert am :date',
        'clear_filters' => 'Filter löschen',
        'results_count' => '{0} Keine Ergebnisse|{1} :count Ergebnis|[2,*] :count Ergebnisse',
        'loading' => 'Laden…',
  ),
  'rate_changes' => 
  array (
  ...
  array (
    ...
    'history_desc' => 'Vollständiger Verlauf der MwSt.-Satzänderungen in allen EU-Ländern',
        'top_calculations' => 'Top MwSt-Berechnungen',
        'top_calculations_desc' => 'Die beliebtesten MwSt-Berechnungen in allen EU-Ländern',
        'mcp_server' => 'MCP-Server',
        'mcp_server_desc' => 'Model Context Protocol-Server für KI-gestützte MwSt-Abfragen',
    'heading' => 'Site',
    'heading_accent' => 'Map',
  ...
  'plus' => 'Plus',
  'minus' => 'Minus',
  'vat_in' => 'MwSt. in :country',
  'rate_label' => ':name Satz',
  'vat_added' => 'MwSt. hinzugefügt',
  'vat_extracted' => 'MwSt. herausgerechnet',
  'net_amount' => 'Nettobetrag',
  'gross_amount' => 'Bruttobetrag',
  'vat_percent' => 'MwSt. :rate%',
  'result' => 'Ergebnis',
  'total_incl_vat' => 'Gesamt inkl. MwSt.',
  'net_excl_vat' => 'Netto exkl. MwSt.',
  'switch_to_add' => 'MwSt. hinzufügen',
  'switch_to_extract' => 'MwSt. herausrechnen',
  'breakdown_title' => 'Berechnungsaufschlüsselung',
  'country' => 'Land',
  'vat_rate' => 'MwSt.-Satz',
  'mode' => 'Modus',
  'add_vat_to_net' => 'MwSt. zum Nettobetrag hinzufügen',
  'extract_vat_from_gross' => 'MwSt. aus Bruttobetrag herausrechnen',
  'net_excl_label' => 'Nettobetrag (exkl. MwSt.)',
  'vat_amount' => 'MwSt.-Betrag',
  'total_incl' => 'Gesamt (inkl. MwSt.)',
  'formula_title' => 'So wurde berechnet',
  ...
  'all_rates_title' => 'Alle :country MwSt.-Sätze',
  'switch_mode' => 'Modus wechseln',
  'add_vat_to_amount' => 'MwSt. zum Betrag hinzufügen',
  'remove_vat_from_amount' => 'MwSt. vom Betrag abziehen',
  ...
  'vat_on_amount' => 'MwSt. auf €:amount',
  'country' => 'Land',
  'rate' => 'Satz',
  'vat_amount' => 'MwSt.-Betrag',
  'total_incl_vat' => 'Gesamt inkl. MwSt.',
  'actions' => 'Aktionen',
  'add_vat' => '+ MwSt. hinzufügen',
  'remove_vat' => '− MwSt. abziehen',
  'calculations_count' => ':count Berechnungen',
  'view_all' => 'Alle :count Berechnungen anzeigen →',
