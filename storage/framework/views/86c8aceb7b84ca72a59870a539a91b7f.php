...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'Slow Queries','title' => 'Time: '.e(number_format($time)).'ms; Run at: '.e($runAt).';','details' => ''.e($config['threshold']).'ms threshold, past '.e($this->periodForHumans()).'']); ?>
...
<?php $component->withAttributes(['class' => '!p-0 truncate max-w-[1px]']); ?>
                                <div class="relative">
                                    <div class="bg-gray-700 dark:bg-gray-800 py-4 rounded-md text-gray-100 block text-xs whitespace-nowrap overflow-x-auto [scrollbar-color:theme(colors.gray.500)_transparent] [scrollbar-width:thin]">
                                        <code class="px-3"><?php echo $config['highlighting'] ? $sqlFormatter->highlight($query->sql) : $query->sql; ?></code>
...
<?php endif; ?>
<?php /**PATH /home/runner/work/eu-vat.info/eu-vat.info/vendor/laravel/pulse/resources/views/livewire/slow-queries.blade.php ENDPATH**/ ?>