<div class="bg-white p-6 rounded-xl shadow-xl mb-6">
    ...
    <div class="space-y-3">
        <a href="https://ec.europa.eu/taxation_customs/vies/" 
           ...
           class="flex items-center gap-3 p-3 hover:bg-blue-50 rounded-lg transition-colors group">
        ...
        <a href="https://europa.eu/youreurope/business/taxation/vat/" 
           target="_blank"
           rel="noopener noreferrer"
           class="flex items-center gap-3 p-3 hover:bg-blue-50 rounded-lg transition-colors group">
...
<?php /**PATH /home/runner/work/eu-vat.info/eu-vat.info/resources/views/components/useful-vat-links.blade.php ENDPATH**/ ?>