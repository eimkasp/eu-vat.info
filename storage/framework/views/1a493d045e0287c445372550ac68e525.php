   <div class="lg:col-start-3 lg:row-end-1 ">
       ...
       <div class="rounded-lg bg-gray-800 shadow-sm ring-1 ring-gray-900/5">
           <dl class="grid">
               <div class="flex-auto px-6 pt-6">
                   <div class="flex justify-between items-center align-center">
                       <div>
                           <h2 class="text-lg text-white !mt-0"> <?php echo e($country->name); ?> </h2>
                       </div>
                       <div>
                           <img class="mb-3 h-9 rounded" src="https://flagcdn.com/h80/<?php echo e(strtolower($country->iso_code)); ?>.jpg" />
                       </div>
                   </div>
               ...
               <div class="flex-none self-end px-6 pt-4">
                   ...
                   <a href="/" wire:navigate
                       ...
                       VAT Rank: <?php echo e($country->countryRank()); ?>
           ...
           <div class="border-t border-gray-900/5 px-6 py-6">
               <a wire:navigate href="<?php echo e(route('country.vat.history', $country->slug)); ?>"
...
<?php /**PATH /home/runner/work/eu-vat.info/eu-vat.info/resources/views/components/country-stats.blade.php ENDPATH**/ ?>