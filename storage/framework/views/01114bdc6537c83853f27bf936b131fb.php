...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'Slow Jobs','title' => 'Time: '.e(number_format($time, 0)).'ms; Run at: '.e($runAt).';','details' => ''.e($config['threshold']).'ms threshold, past '.e($this->periodForHumans()).'']); ?>
...
<?php endif; ?>
                <tbody>
                    <?php $__currentLoopData = $slowJobs->take(100); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $job): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php endif; ?>
<?php /**PATH /home/runner/work/eu-vat.info/eu-vat.info/vendor/laravel/pulse/resources/views/livewire/slow-jobs.blade.php ENDPATH**/ ?>