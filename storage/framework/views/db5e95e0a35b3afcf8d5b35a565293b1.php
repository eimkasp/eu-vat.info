<div class="relative"
 x-data="{
                hoveredCountry: null,
                selectedCountry: <?php if($activeCountry): ?> <?php echo e(json_encode($countryData[strtoupper($activeCountry->iso_code)] ?? null)); ?> <?php else: ?> null <?php endif; ?>,
                mouseX: 0,
                mouseY: 0,
                countryData: <?php if ((object) ('countryData') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('countryData'->value()); ?>')<?php echo e('countryData'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('countryData'); ?>')<?php endif; ?>,
                getColor(rate) {
...
>
    ...
    <div class="max-w-7xl mx-auto">
        <div class="<?php echo e($layout === 'split' ? 'grid grid-cols-1 md:grid-cols-2 gap-6' : ''); ?>">
            <!-- Map Container -->
            <div class="eu-map-container relative">
                ...
                <!-- SVG Map -->
                <div class="relative <?php echo e($layout === 'single' ? 'ml-[-80px]' : ''); ?>">
                    <?php echo file_get_contents(resource_path('images/europe.svg')); ?>
            ...
            <div x-show="selectedCountry" x-cloak 
                class="<?php echo e($layout === 'split' ? 'md:mt-0' : 'mt-6'); ?> bg-white p-6 rounded-lg shadow-lg border">
                <template x-if="selectedCountry">
                    <div>
                        ...
                        <template x-if="'<?php echo e($layout); ?>' === 'split'">
        ...
        <div x-show="'<?php echo e($layout); ?>' === 'single'" class="text-center mt-3 mb-3">
...
</div><?php /**PATH /home/runner/work/eu-vat.info/eu-vat.info/resources/views/livewire/europe-map.blade.php ENDPATH**/ ?>