<div class="bg-white p-6 rounded-xl shadow-xl border border-gray-100">
    <div class="mb-6">
        <h3 class="text-xl font-bold text-gray-900">🌍 EU VAT Rates History (2000-<?php echo e(date('Y')); ?>)</h3>
...
</div><?php /**PATH /home/runner/work/eu-vat.info/eu-vat.info/resources/views/livewire/all-countries-vat-history.blade.php ENDPATH**/ ?>