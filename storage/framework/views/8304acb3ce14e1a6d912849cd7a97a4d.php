...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'Slow Outgoing Requests','title' => 'Time: '.e(number_format($time)).'ms; Run at: '.e($runAt).';','details' => ''.e($config['threshold']).'ms threshold, past '.e($this->periodForHumans()).'']); ?>
...
<?php endif; ?>
<?php /**PATH /home/runner/work/eu-vat.info/eu-vat.info/vendor/laravel/pulse/resources/views/livewire/slow-outgoing-requests.blade.php ENDPATH**/ ?>