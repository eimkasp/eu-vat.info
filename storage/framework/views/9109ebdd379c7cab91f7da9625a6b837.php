<ul role="list" class="flex overflow-x-scroll  gap-x-6 gap-y-8 py-6 lg:grid-cols-3 xl:gap-x-8">
    <?php $__currentLoopData = $relatedCountries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $singleCountry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH /home/runner/work/eu-vat.info/eu-vat.info/resources/views/components/related-countries.blade.php ENDPATH**/ ?>