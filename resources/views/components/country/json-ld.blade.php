...
{!! json_encode([
    ...
    '@type' => 'BreadcrumbList',
    'itemListElement' => [
        ['@type' => 'ListItem', 'position' => 1, 'name' => __('ui.breadcrumbs.home'), 'item' => url(locale_path('/'))],
        ['@type' => 'ListItem', 'position' => 2, 'name' => $country->name, 'item' => url(locale_path('/vat-calculator/' . $country->slug))],
    ],
...
{!! json_encode([
    ...
    'url' => url(locale_path('/vat-calculator/' . $country->slug)),
    'breadcrumb' => [
        '@type' => 'BreadcrumbList',
        'itemListElement' => [
            ['@type' => 'ListItem', 'position' => 1, 'name' => __('ui.breadcrumbs.home'), 'item' => url(locale_path('/'))],
