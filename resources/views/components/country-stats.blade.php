   <div class="lg:col-start-3 lg:row-end-1 ">
       ...
       <div class="rounded-lg bg-gray-800 shadow-sm ring-1 ring-gray-900/5">
           <dl class="flex flex-wrap">
               ...
               <div class="border-t border-gray-100/5 pt-6 mt-6">
                   <div class="country-sub-details flex w-full flex-none gap-x-4 px-6">
                       <dt class="flex-none">
                   ...
                   <div class="country-sub-details mt-4 flex w-full flex-none gap-x-4 px-6">
                       <dt class="flex-none">
                           <span class="sr-only">GDP PER CAPITA, PPP
                       ...
                       <dd class="text-sm leading-6 text-gray-500">
                           <time datetime="2023-01-31">POPULATION
