    ...
    <div class="relative pt-8 pb-12">
        ...
        <div class="absolute inset-0 z-0">
            @isset($selectedCountryObject)
                ...
                @if(file_exists(resource_path('images/countries/' . strtolower($selectedCountryObject->iso_code) . '.jpg')))
                    <img src="{{ Vite::asset('resources/images/countries/' . strtolower($selectedCountryObject->iso_code) . '.jpg') }}" alt="" class="w-full h-full object-cover" loading="eager">
                @else
                    <img src="{{ Vite::asset('resources/images/eu-vat-calculator-background.jpg') }}" alt="" class="w-full h-full object-cover" loading="eager">
                @endif
            @else
                <img src="{{ Vite::asset('resources/images/eu-vat-calculator-background.jpg') }}" alt="" class="w-full h-full object-cover" loading="eager">
            @endisset
