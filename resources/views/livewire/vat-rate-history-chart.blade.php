    ...
    @if($earliestRate && $currentRate)
        <div class="grid grid-cols-2 sm:grid-cols-3 gap-3 mb-5">
            <div class="bg-white p-3 rounded-lg shadow-sm border border-gray-200">
                ...
                <div class="text-xl font-bold text-gray-900">{{ number_format($earliestRate, 1) }}%</div>
            </div>
            <div class="bg-white p-3 rounded-lg shadow-sm border border-gray-200">
                <div class="text-xs text-gray-600 mb-1">Current Rate</div>
                <div class="text-xl font-bold text-gray-900">{{ number_format($currentRate, 1) }}%</div>
            </div>
            <div class="bg-white p-3 rounded-lg shadow-sm border border-gray-200 col-span-2 sm:col-span-1">
                ...
                <div class="text-xl font-bold {{ $rateChange > 0 ? 'text-red-600' : ($rateChange < 0 ? 'text-green-600' : 'text-gray-900') }}">
