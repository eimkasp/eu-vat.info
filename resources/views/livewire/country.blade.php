                ...
                <section id="calculator">
                    <div class="grid md:grid-cols-2 gap-3">
                        <div class="bg-white p-4 rounded-xl shadow-sm border border-gray-200">
                            <h3 class="text-sm font-bold mb-2 text-gray-900">{{ __('ui.country_page.adding_vat', ['rate' => $country->standard_rate]) }}</h3>
                        ...
                        <div class="bg-white p-4 rounded-xl shadow-sm border border-gray-200">
                            <h3 class="text-sm font-bold mb-2 text-gray-900">{{ __('ui.country_page.removing_vat', ['rate' => $country->standard_rate]) }}</h3>
                            <div class="bg-gray-50 p-3 rounded-lg font-mono text-sm text-gray-800 border border-gray-200 mb-2">
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200">
                        <div class="grid grid-cols-2 sm:grid-cols-3 gap-px">
                            ...
                            <div class="p-4">
                                ...
                                <dd class="mt-1 text-lg font-semibold text-gray-900">{{ $country->standard_rate }}%</dd>
                            </div>
                            <div class="p-4">
                                <dt class="text-xs font-medium text-gray-500 uppercase tracking-wider">{{ __('ui.country_page.vat_number_format') }}</dt>
                                <dd class="mt-1 text-lg font-semibold text-gray-900">{{ $country->iso_code }}XXXXXXXXX</dd>
                            </div>
                            <div class="p-4">
                                <dt class="text-xs font-medium text-gray-500 uppercase tracking-wider">{{ __('ui.country_page.eu_member') }}</dt>
                                <dd class="mt-1 text-lg font-semibold {{ $country->is_eu_member ? 'text-green-600' : 'text-gray-500' }}">
                                    {{ $country->is_eu_member ? __('ui.country_page.yes') : __('ui.country_page.no') }}
                                </dd>
                            </div>
                            <div class="p-4">
                                <dt class="text-xs font-medium text-gray-500 uppercase tracking-wider">{{ __('ui.country_page.vies_validation') }}</dt>
                                <dd class="mt-1 text-lg font-semibold {{ $country->vies_available ? 'text-green-600' : 'text-gray-500' }}">
                                    @if($country->vies_available)
                                        <a href="{{ locale_path('/vat-number-validator/' . $country->slug) }}" class="hover:underline">{{ __('ui.country_page.available') }}</a>
                                    @else
