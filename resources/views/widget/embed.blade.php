        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-9">
            <div>
                ...
                <div class="bg-white p-4 rounded-lg shadow-md">
                    ...
                    <pre id="embed-code" class="bg-gray-100 p-4 rounded-lg w-full break-all whitespace-pre-wrap">&lt;iframe src="{{ route('widget.iframe') }}@isset($selectedCountry->slug)/{{ $selectedCountry->slug }}@endisset" style="border:none;outline: none;background: transparent;box-shadow: none;" width="100%" height="400px" frameborder="0"&gt;&lt;/iframe&gt;
        </pre>
