...
<head>
    ...
    <style amp-custom>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .header-cta { display: inline-block; background: #f59e0b; color: #1e293b; font-weight: 700; padding: 7px 16px; border-radius: 6px; font-size: 0.85rem; white-space: nowrap; }
